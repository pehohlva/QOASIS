...
MetaInformation::MetaInformation(const QString &key, const QString &value,
                                 const QString &title)
    : mKey(key), mValue(value), mTitle(title) {}

QString MetaInformation::key() const { return mKey; }

QString MetaInformation::value() const { return mValue; }

QString MetaInformation::title() const { return mTitle; }

StyleInformation::StyleInformation() {}

StyleInformation::~StyleInformation() {}

void StyleInformation::addFontProperty(const QString &name,
...
void StyleInformation::addStyleProperty(const QString &name,
...
void StyleInformation::addPageProperty(const QString &name,
...
void StyleInformation::addListProperty(const QString &name,
...
void StyleInformation::addMasterLayout(const QString &name,
...
QString StyleInformation::masterPageName() const {
  return mMasterPageName.isEmpty() ? mMasterLayouts[QStringLiteral("Standard")]
                                   : mMasterLayouts[mMasterPageName];
}

void StyleInformation::addMetaInformation(const QString &key,
                                          const QString &value,
                                          const QString &title) {
