...
Rectangle {
    ...
    Rectangle {
        ...
        width: trackwi /// PlayerConfig.previewEnabled ? Utils.scaled(180) : previewText.contentWidth + 2*Utils.kSpacing
        height: trackwi / 10 ///  // PlayerConfig.previewEnabled ? Utils.scaled(120) : previewText.contentHeight + 2*Utils.kSpacing
        color: "green"
        state: "out"
        ...
        Text {
            ...
            anchors.top: parent.bottom  ///PlayerConfig.previewEnabled ? video.bottom : parent.top
            text: ""
            color: "white"
