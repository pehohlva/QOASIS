...
Item {
    /// Slider to drag + & - on buffered audio/video
        ...
        property real value_frame: 15
        property alias mediaValue: value_frame
        signal valueChance(int  value_frame)
        id: mediaslider;
        ...
        ///// color: "black"
        x:0;
        y:(dohavingangle == 0)? mainordery :tumbspace;
        transform: Rotation {
        ...
        /* cursor xxxxxxxxxxx in slider to drag   */
        Rectangle {
