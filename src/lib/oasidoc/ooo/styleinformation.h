...
public:
  ...
  MetaInformation(const QString &key, const QString &value,
                  const QString &title);
...
public:
  ...
  void addStyleProperty(const QString &name,
  ...
  void addMetaInformation(const QString &key, const QString &value,
                          const QString &title);
