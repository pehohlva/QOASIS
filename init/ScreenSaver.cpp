...
//http://www.cocoachina.com/macdev/cocoa/2010/0201/453.html 404!!
...
#  if MAC_OS_X_VERSION_MIN_REQUIRED >= MAC_OS_X_VERSION_10_8
	/// not exist after mac osx 11!! give error
	//// https://www.apple.com/us/search/IOPMAssertionRelease?src=serp
	/*  
...
#  else // OSX >= 10.8, use new API
	////// not exist after mac osx 11
	/// hack to prevent sleep graphic old historical
	/*  
